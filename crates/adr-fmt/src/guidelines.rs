...
pub fn print_setup_guide() {
    ...
    println!("  adr-fmt --guidelines          Print governance guidelines explicitly");
    ...
    println!("  adr-fmt --report              Computed children index");
...
fn print_template() {
    ...
    println!("          layer 1–12 still enforced. Exceeding may indicate");
