...
pub fn command_done_stream_config() -> stream::Config {
    stream::Config {
...
pub fn status_stream_config() -> stream::Config {
    stream::Config {
...
pub fn validator_consumer_config() -> consumer::pull::Config {
...
pub fn executor_consumer_config() -> consumer::pull::Config {
    consumer::pull::Config {
...
pub fn media_object_store_config() -> jetstream::object_store::Config {
...
pub async fn ensure_media_object_store(
    ...
    let config = media_object_store_config();
