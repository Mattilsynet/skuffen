...
SKU-0007 er superseded by SKU-0016. R1, R4, R9, R10 og R11 er videreført: entity
state lagrer facts, saksansvarlig er kun prerequisite for `AvsluttSak`, og
feildiagnostikk hører ikke hjemme i entity state. R2, R3, R5, R6, R8 og R12 er
forkastet — `CommandStateDecision` og `planlegg_neste_handling` erstattes av
persisterte operasjonsrader med `dekomponer` og `vurder`.
