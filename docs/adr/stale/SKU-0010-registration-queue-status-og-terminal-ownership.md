...
SKU-0010 er superseded by SKU-0016. Problemet finnes ikke lenger: dekomponering
skriver ikke kommandostatus, fordi kommandostatus ikke er en kolonne men et fold
over `operasjon`. Terminal lifecycle eies av foldet, ikke av en navngitt
tjeneste.
